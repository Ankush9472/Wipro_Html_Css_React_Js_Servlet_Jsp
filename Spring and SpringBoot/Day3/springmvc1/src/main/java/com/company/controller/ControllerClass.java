...
public class ControllerClass {
    ...
    //(here in model we are setting data by binding the form.jsp elements 
    //with the model class attributes i.e User)
    @RequestMapping(path="/display", method=RequestMethod.POST)
    public String display(@ModelAttribute User user, Model model) {
        //Form data is then setting into a model class object after binding 
        //with an entity class attribute
